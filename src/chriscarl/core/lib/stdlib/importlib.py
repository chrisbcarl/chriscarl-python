...
def walk_module_names_filepaths(module=__name__):
    # type: (Union[ModuleType, str]) -> Generator[Tuple[str, str], None, None]  # noqa: E501
    '''
    Description:
                ...
                if file_ext.lower() == '.py':
                    ...
                    if file_name == '__init__':
                        ...
                        if len(module_path.parts) > 1:
                            module_path_parts = list(module_path.parts)[0:-1]
                        else:
...
def walk_module(module=__name__):
    # type: (Union[ModuleType, str]) -> Generator[Tuple[ModuleType, Union[Tuple[Type, Exception, TracebackType], Tuple[None, None, None]]], None, None]  # noqa: E501
    '''
    Description:
        module: Union[ModuleType, str]
            either provide a module object or just provide the string and we'll import it by side effect.
